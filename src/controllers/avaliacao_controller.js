...
class assessment_controller extends crud{
  ...
  async read(req, res) {
    model.findAll({
      where: {},
      raw: true , 
      attributes: ['id', 'value', 'feedback', 'teacher_id'],
      include: [
        {model: user,      
...
export default new assessment_controller()